...
| [splunk.es.splunk_data_inputs_monitors](https://github.com/ansible-collections/splunk.es/blob/main/docs/splunk.es.splunk_data_inputs_monitors_module.rst)         | Manage Splunk Data Inputs of type Monitor                          |
